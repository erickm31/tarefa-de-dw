// DADOS (simulando nosso banco de dados em memória)
const tarefas = [
...
export async function atualizar(id, dadosAtualizados) {
  ...
  if (index === -1) return null; // Retorna nulo se não encontrar
...
export async function remover(id) {
  ...
  if (index === -1) return false; // Retorna falso se não encontrar
